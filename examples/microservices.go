...
func microservice1method(data string, events []wf.Event) ([]wf.Action, []wf.PublishTrigger, error) {
...
func microservice2method(data string, events []wf.Event) ([]wf.Action, []wf.PublishTrigger, error) {
